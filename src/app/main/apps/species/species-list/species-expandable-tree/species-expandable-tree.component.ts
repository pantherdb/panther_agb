...
export class SpeciesD3TreeComponent implements OnInit {
  ...
  loadTree () {
    ...
    const treeJSON = d3.json("assets/data/species-nodes-14.json", function (error, treeData) {
      ...
      var duration = 750;
      var root;
      var nodes, links, nodePaths, nodesExit;
      ...
      var baseSvg = d3.select("#d3-tree-container").append("svg")
      ...
      /* var dragListener = d3.behavior.drag()
        ...
        .on("drag", (d: any, i) => {
          ...
          d.x0 += (<any>d3.event).dy;
          d.y0 += (<any>d3.event).dx;
      ...
      function update(source) {
        ...
        nodes.forEach(function (d) {
          //console.log(d);
          d.y = (d.depth * (maxLabelLength * 8)); //maxLabelLength * 1px
